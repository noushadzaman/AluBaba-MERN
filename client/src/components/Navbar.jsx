...
const Navbar = () => {
    ...
    return (
        <nav className="fixed w-full top-0 z-50 flex items-center justify-between font-medium text-white">
            <div className="absolute flex items-center justify-center w-full">
                <Link to={'/'}>
                    <img src={assets.logo} className="w-36" alt="logo" />
                </Link>
            </div>
            <div className="w-full z-50 flex items-center justify-between  font-medium text-white">
                <ul className="hidden sm:flex gap-5 test-sm test-gray-700">
